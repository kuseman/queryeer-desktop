import { defineStateKey, type FileStateRegistry } from "@queryeer/api/files/FileStateRegistry";
import type { AssistantChatMessage, AssistantModel } from "@queryeer/api/assistant/Assistant";
