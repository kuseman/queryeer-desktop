 ...
 */
public record JdbcEngineState(String connectionId, String database, JdbcNestedConnection jdbc, String dialectId, String url, java.util.Map<String, Object> properties)
{
